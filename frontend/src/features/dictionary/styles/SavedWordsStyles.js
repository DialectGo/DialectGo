...
export const styles = StyleSheet.create({
  ...
  backBtn: { width: 45, height: 45, backgroundColor: '#FFEDAC', borderRadius: 12, justifyContent: 'center', alignItems: 'center', elevation: 3 },
  ...
  labelUnderline: { fontSize: 14, color: '#4F3422', textDecorationLine: 'underline' },
