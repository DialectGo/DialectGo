...
import { TERMS_AND_CONDITIONS_SECTIONS } from '../../../constants/legalContent';
export default function TermsAndAgreementModal({ visible, onClose, onAccept, isAccepted }) {
  ...
  const handleAccept = async () => {
    if (!localAccepted || isSubmitting) return;
    ...
    <Modal visible={visible} animationType="slide" presentationStyle="pageSheet">
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          <TouchableOpacity onPress={onClose} style={styles.backBtn} accessibilityRole="button" accessibilityLabel="Close">
        ...
        <View style={styles.bottomSection}>
          ...
          <TouchableOpacity
            style={[styles.acceptBtn, (!localAccepted || isSubmitting) && { opacity: 0.5 }]}
            disabled={!localAccepted || isSubmitting}
