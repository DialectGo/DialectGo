  ...
  useEffect(() => {
    if (visible && messages.length === 0) {
      ...
      setMessages([{
        id: 'welcome',
        role: 'assistant',
        content: `Kamusta! 👋 I'm your Global AI Assistant. Ask me anything about Philippine languages, regional dialects, or Filipino culture!`,
      }]);
    }
  }, [visible]);
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <View style={styles.headerLeft}>
              ...
              <View>
                <Text style={styles.headerTitle}>Global AI Assistant</Text>
