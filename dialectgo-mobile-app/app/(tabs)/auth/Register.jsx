...
import { Text, Button, Card, Avatar, TextInput, IconButton, Checkbox } from 'react-native-paper';
            ...
            <View className="px-6 py-2">
              ...
              <View className="px-6 mt-4">
                <View className="flex-row items-center">
                    ...
                    color="#FBBF24" 
                    uncheckedColor="#604B48" 
                    />
                    <Pressable onPress={() => setChecked(!checked)} className="ml-2">
                    <Text className="text-slate-800 text-sm">
                        I agree to the <Text className="font-bold underline">Terms and Conditions</Text>
                    </Text>
                    </Pressable>
                </View>
            </View>
              ...
              <View style={styles.actions} className="pb-2">
                <Button mode="contained" style={{ marginTop: 16, borderRadius: 10 }} buttonColor="#F2F2F2" textColor="#000000" className="p-2">
                  SIGN UP
                </Button>
              ...
              <View className="flex-row items-center justify-center my-2">
                ...
                <Button mode="text" style={{ marginTop: 16, borderRadius: 10 }} textColor="#000000" onPress={() => router.push('/auth/Login')}>
                  Log In
                </Button>
              </View>
          </View>
